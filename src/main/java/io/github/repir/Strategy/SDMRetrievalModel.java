...
import io.github.repir.Strategy.Tools.ScoreFunctionDirichletLM;
...
public class SDMRetrievalModel extends RetrievalModel {
   ...
   public String getQueryToRetrieve() {
      query.setScorefunctionClass(ScoreFunctionDirichletLM.class.getSimpleName());
      return io.github.repir.tools.Lib.PrintTools.sprintf("SDMOrderedPhrases:(%s) SDMUnorderedPhrases:(%s) SDMTerm:(%s)", query.stemmedquery, query.stemmedquery, query.stemmedquery);
   }
