...
public class FDMRetrievalModel extends RetrievalModel {
   ...
   public String getQueryToRetrieve() {
      query.setScorefunctionClass("ScoreFunctionDirichletLM");
      return io.github.repir.tools.Lib.PrintTools.sprintf("FDMOrderedPhrases:(%s) FDMUnorderedPhrases:(%s) FDMTerm:(%s)", query.stemmedquery, query.stemmedquery, query.stemmedquery);
   }
}
