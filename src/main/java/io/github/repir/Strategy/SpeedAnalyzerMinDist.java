 ...
 * @author jeroen
 */
public class SpeedAnalyzerMinDist extends MinDistRetrievalModel implements Analyzer {

   public static Log log = new Log(SpeedAnalyzerMinDist.class);
   public SpeedCollector collector;

   public SpeedAnalyzerMinDist(Retriever retriever) {
      super(retriever);
   }
